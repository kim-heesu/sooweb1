...
const docSlider = (function () {
    ...
    const u = {
        ...
        updatePager : function () {
            ...
            /*fade area*/
            var section1 = $('.docSlider-pager button:nth-child(1)');
            var section2 = $('.docSlider-pager button:nth-child(2)');
            var section3 = $('.docSlider-pager button:nth-child(3)');
            var section4 = $('.docSlider-pager button:nth-child(4)');
            var section5 = $('.docSlider-pager button:nth-child(5)');

            if($(section2).hasClass("selected")){
                $('.section2 .fade-area').addClass('active');
            }else{
                $('.section2 .fade-area').removeClass('active');
            }

            if($(section3).hasClass("selected")){
                $('.section3 .fade-area').addClass('active');
            }else{
                $('.section3 .fade-area').removeClass('active');
            }

            if($(section4).hasClass("selected")){
                $('.section4 .fade-area').addClass('active');
            }else{
                $('.section4 .fade-area').removeClass('active');
            }

            if($(section5).hasClass("selected")){
                $('.section5 .fade-area').addClass('active');
            }else{
                $('.section5 .fade-area').removeClass('active');
            }
